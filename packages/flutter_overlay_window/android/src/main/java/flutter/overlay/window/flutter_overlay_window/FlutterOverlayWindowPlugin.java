...
public class FlutterOverlayWindowPlugin implements
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        // Only set WindowSetup.messenger for the first (main) engine.
        // The overlay engine also auto-registers this plugin, and if we
        // overwrite here, overlay→main messages would be routed back
        // to the overlay Dart isolate instead of the main one.
    ...
    public void onDetachedFromEngine(@NonNull FlutterPluginBinding binding) {
        ...
        // Only clear the static reference if this instance owns it
    ...
    public void onMessage(@Nullable Object message, @NonNull BasicMessageChannel.Reply reply) {
        Log.d("OverlayIPC", "main→overlay handler fired, message="
        ...
        try {
            ...
            if (overlayEngine == null) {
                Log.e("OverlayIPC", "overlay engine is NULL — cannot forward to overlay");
                reply.reply(null);
                return;
            }
            ...
            Log.d("OverlayIPC", "forwarded to overlay engine OK");
        } catch (Exception e) {
            Log.e("OverlayIPC", "send to overlay engine FAILED: " + e.getMessage(), e);
            reply.reply(null);
        }
    }
